...
12 ชม. ได้จริง โดยยังไม่ต้องมีเฟรมภาพเลย (เดินคู่ขนานกับการดาวน์โหลดเฟรมของ ticket 03)
    ...
    python backend/scripts/xray_sequence_gate_check.py
...
from sunseg.data.build_sequences import build_flare_lookup, build_sequences, clean_sharp_frame  # noqa: E402
...
STUDY_SEQUENCE_LENGTH = 8  # 12h x 8 = ประวัติ 4 วัน (ดู spec เรื่องเหตุผลของค่านี้)

"""วัดตัวคูณสเกลระหว่างดาวเทียม GOES สองรุ่น จากช่วงเวลาที่ทั้งสองดวงทำงานทับกันจริง
    ...
    python backend/scripts/measure_xray_cross_calibration.py
...
from download_xray import download as download_xray  # noqa: E402
...
def main() -> int:
    ...
    from download_xray import download as download_xray  # noqa: E402  (sys.path มี scripts/ อยู่แล้วผ่าน __main__)

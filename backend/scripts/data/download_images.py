"""ดาวน์โหลดภาพ HMI แล้วสร้างคู่ (magnetogram, mask) สำหรับเทรน U-Net
    ...
    python backend/scripts/data/download_images.py
...
def main() -> int:
    ...
    logger.info("  1) ตรวจด้วยตา:  python backend/scripts/segmentation/plot_masks.py")
    logger.info("  2) เทรนโมเดล:   python backend/scripts/segmentation/train.py")
    logger.info("=" * 70)

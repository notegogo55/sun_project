...
/** กราฟย่อใต้จานสุริยะใน hero — เวอร์ชันย่อของ ProtonCard แสดงเฉพาะช่อง >10 MeV
 *  (ช่องอ้างอิงของ NOAA S-scale) เส้นเดียว พื้นที่แคบเกินจะใส่ทั้งสี่เส้น + legend */
export default function HeroProtonChart() {
  ...
  return (
    <div className="hero__minichart-wrap" id="heroMinichart">
      <div className="hero__minichart-label">
        <span className="hero__minichart-title">Proton flux</span>
